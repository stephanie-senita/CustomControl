		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP Custom Controls",
									"targetURL": "#caplibrariestestui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"caplibrariestestui-display": {
								"semanticObject": "caplibrariestestui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cap.libraries.testui",
									"url": sap.ui.require.toUrl("cap/libraries/testui")
								}
							}
						}
					}
